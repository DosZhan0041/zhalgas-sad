...
function HeroDecorations() {
  return (
    <div className="hero-deco">
      ...
      <svg
        style={{ top: "5%", right: "3%", animation: "kd-spin 22s linear infinite", opacity: 0.88 }}
      ...
      >
        {SUN_RAYS.map(deg => {
          ...
          return (
            <line key={deg}
              x1={38 + 22 * Math.cos(r)} y1={38 + 22 * Math.sin(r)}
              x2={38 + 33 * Math.cos(r)} y2={38 + 33 * Math.sin(r)}
      ...
      <svg
        className="hide-sm"
        style={{ top: "5%", left: "2%", animation: "kd-drift 7s ease-in-out infinite", opacity: 0.6 }}
        width="115" height="58" viewBox="0 0 115 58"
      >
        <g fill="white">
      ...
      <svg
        className="hide-sm"
        style={{ bottom: "23%", right: "3%", animation: "kd-drift-rev 9s ease-in-out infinite", opacity: 0.48 }}
        width="95" height="46" viewBox="0 0 95 46"
      >
        <g fill="white">
      ...
      <svg
        ...
        width="290" height="115" viewBox="0 0 290 115"
      >
        <path d="M10,115 Q145,-22 280,115" stroke="#FF6B6B" strokeWidth="9" fill="none" strokeLinecap="round"/>
        <path d="M22,115 Q145,-5  268,115" stroke="#FFB300" strokeWidth="9" fill="none" strokeLinecap="round"/>
        <path d="M35,115 Q145,12  255,115" stroke="#56CB8F" strokeWidth="9" fill="none" strokeLinecap="round"/>
        <path d="M47,115 Q145,29  243,115" stroke="#4D96FF" strokeWidth="9" fill="none" strokeLinecap="round"/>
        <path d="M60,115 Q145,46  230,115" stroke="#AB6FDB" strokeWidth="9" fill="none" strokeLinecap="round"/>
      </svg>
      ...
      {STAR_POSITIONS.map((s, i) => (
        <svg
          ...
          style={{ top: s.top, left: s.left, animation: `kd-twinkle 2.8s ease-in-out ${s.delay} infinite` }}
          width={s.size} height={s.size} viewBox="0 0 24 24" fill={s.color}
        >
      ...
      <svg
        style={{ top: "17%", right: "22%", animation: "kd-float 4s ease-in-out infinite", opacity: 0.82 }}
        width="46" height="72" viewBox="0 0 46 72"
      >
        <ellipse cx="23" cy="26" rx="18" ry="22" fill="#FF6B6B"/>
        <path d="M23 48 L19 54 L27 54 Z" fill="#FF6B6B"/>
        <path d="M23 54 Q28 62 22 70" stroke="#e05555" strokeWidth="1.6" fill="none"/>
      ...
      <svg
        className="hide-sm"
        style={{ bottom: "28%", left: "3%", animation: "kd-float-twist 5s ease-in-out 1s infinite", opacity: 0.75 }}
        width="40" height="64" viewBox="0 0 46 72"
      >
        <ellipse cx="23" cy="26" rx="18" ry="22" fill="#4D96FF"/>
        <path d="M23 48 L19 54 L27 54 Z" fill="#4D96FF"/>
        <path d="M23 54 Q28 62 22 70" stroke="#3a7fd5" strokeWidth="1.6" fill="none"/>
        <ellipse cx="15" cy="17" rx="5" ry="7" fill="rgba(255,255,255,0.3)"/>
      </svg>
      ...
      <svg
        className="hide-sm"
        style={{ top: "42%", left: "0%", animation: "kd-float 6s ease-in-out 2.5s infinite", opacity: 0.65 }}
        width="34" height="56" viewBox="0 0 46 72"
      >
        <ellipse cx="23" cy="26" rx="18" ry="22" fill="#56CB8F"/>
        <path d="M23 48 L19 54 L27 54 Z" fill="#56CB8F"/>
        <path d="M23 54 Q28 62 22 70" stroke="#3aa872" strokeWidth="1.6" fill="none"/>
        <ellipse cx="15" cy="17" rx="5" ry="7" fill="rgba(255,255,255,0.3)"/>
      </svg>
      ...
      <svg
        className="hide-sm"
        style={{ bottom: "13%", right: "7%", animation: "kd-bounce 4s ease-in-out 0.5s infinite", opacity: 0.72 }}
        width="54" height="54" viewBox="0 0 60 60"
      >
        {FLOWER_PETALS.map(deg => {
          ...
          return (
            <ellipse key={deg} cx={cx} cy={cy} rx="8" ry="5"
              fill="#FF9DE2" transform={`rotate(${deg} ${cx} ${cy})`}
            />
          );
        })}
...
type DecoItem = { top: string; left?: string; right?: string; size: number; color: string; delay: string };

const CTA_STARS: DecoItem[] = [
  { top: "12%", left: "4%",  size: 20, color: "rgba(255,255,255,0.55)", delay: "0s"   },
  { top: "70%", left: "8%",  size: 14, color: "rgba(255,255,255,0.4)",  delay: "0.6s" },
  { top: "20%", right: "5%", size: 18, color: "rgba(255,255,255,0.5)",  delay: "1.0s" },
  { top: "65%", right: "9%", size: 12, color: "rgba(255,255,255,0.45)", delay: "0.4s" },
  { top: "40%", left: "50%", size: 10, color: "rgba(255,255,255,0.35)", delay: "1.4s" },
];

const CTA_HEARTS: DecoItem[] = [
  { top: "30%", left: "2%",  size: 22, color: "rgba(255,255,255,0.3)",  delay: "0.3s" },
  { top: "55%", right: "3%", size: 18, color: "rgba(255,255,255,0.25)", delay: "1.1s" },
];
  ...
  return (
    <div className="cta-deco">
      {CTA_STARS.map((s, i) => (
        <svg
          key={i}
          style={{ top: s.top, left: s.left, right: s.right, animation: `kd-twinkle 3s ease-in-out ${s.delay} infinite` }}
          width={s.size} height={s.size} viewBox="0 0 24 24" fill={s.color}
        >
          <path d="M12 2l2.09 6.26L20 9.27l-4.91 4.79 1.16 6.76L12 17.77l-4.25 3.05 1.16-6.76L4 9.27l5.91-.01L12 2z"/>
        </svg>
      ...
      {CTA_HEARTS.map((h, i) => (
        <svg
          key={i}
          style={{ top: h.top, left: h.left, right: h.right, animation: `kd-float 4s ease-in-out ${h.delay} infinite` }}
          width={h.size} height={h.size} viewBox="0 0 24 24" fill={h.color}
        >
...
const features = [
  ...
  },
  {
    ...
    color: "green",
    title: "Лицензия бар",
    desc: "Мемлекеттік аттестациядан өткен",
  },
];
          ...
          <div className="hero-grid">
            <div className="hero-content">
              ...
              <p className="hero-subtitle">
                ...
                қамтамасыз етеміз. Профессионал тәрбиешілер, жылы атмосфера,
